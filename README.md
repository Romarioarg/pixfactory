...
GET    /api/contratos
GET    /api/cobrancas
GET    /api/cobrancas/atrasadas
POST   /api/cobrancas/{id}/pagamentos
POST   /api/cobrancas/{id}/promessa
POST   /api/cobrancas/{id}/contato
POST   /api/cobrancas/{id}/estorno
GET    /api/cobrancas/{id}/recibo
GET    /api/cobrancas/{id}/extrato
GET    /api/cobrancas/follow-up
GET    /api/busca?q=
POST   /api/contracts/{id}/actions/quitar_antecipado
POST   /api/simulacoes
GET    /api/caixa/hoje
